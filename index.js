...
var wordsToGuess = ["Hi", "Hello", "How Are You", "I'm Fine", "Thank You", "And You", "Good Morning", "Good Afternoon", "Good Evening", "What's Up", "Howdy", "Yo"];
var randomWord;
var chosenWord;

function startGame() {

    console.log(chalk.blue("It's time to guess the greetings wards!"));
}
